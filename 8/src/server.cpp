...
#define PRINT_MESSAGE_QUEUE_STATE \
	...
	std::cout \
	  ...
	  << "\townership and permissions:\n" \
			<< "\t\tcreator user ID: "  << messageQueueState.msg_perm.cuid << '\n' \
			<< "\t\tcreator group ID: " << messageQueueState.msg_perm.cgid << '\n' \
			<< "\t\towner user ID: "  	<< messageQueueState.msg_perm.uid  << '\n' \
			<< "\t\towner group ID: " 	<< messageQueueState.msg_perm.gid  << '\n' \
			<< "\t\tpermissions: " \
		...
		<< "\t# of messages in queue: "	<< messageQueueState.msg_qnum   << '\n' \
